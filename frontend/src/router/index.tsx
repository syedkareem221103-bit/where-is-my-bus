...
const DriverAnalyticsDashboard = React.lazy(() => import('@/pages/admin/DriverAnalyticsDashboard').then(m => ({ default: m.DriverAnalyticsDashboard })));
const RouteAnalyticsDashboard = React.lazy(() => import('@/pages/admin/RouteAnalyticsDashboard').then(m => ({ default: m.RouteAnalyticsDashboard })));
        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                ...
                element: withSuspense(DriverAnalyticsDashboard),
              },
              {
                path: 'analytics/routes',
                element: withSuspense(RouteAnalyticsDashboard),
              },
              {
                path: 'settings',
